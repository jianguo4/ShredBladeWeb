...
export default function FourShaftShredderBlades() {
  ...
  const bladeImages = useMemo(() => {
    ...
    return Object.entries(bladeImageModules)
      .map(([path, mod]) => {
        ...
        const alt = altTextMap[fileName] || `Four shaft shredder blade - ${fileName.replace(/\.[^.]+$/, '').replace(/[-_]+/g, ' ')}`;
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-start justify-center h-full pl-8 pr-4 sm:pl-12 md:pl-20 lg:pl-32 xl:pl-48 text-white transition-all duration-700 max-w-2xl"
          ...
          <p className="text-xl md:text-2xl text-slate-200 font-light tracking-wide drop-shadow-lg leading-relaxed">
            Ultra-fine shredding blades for precise particle control. Perfect for plastic films, MSW, and TDF with consistent output quality.
          </p>
        </div>
      </section>
      ...
      <div className="w-full px-2 sm:px-4 mt-12 md:mt-20">
        <section className="mb-16">
          <div className="text-left mb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base sm:text-lg text-slate-700 leading-relaxed max-w-4xl">
              Precision Four Shaft Blades for Fine Shredding & Particle Size Control.
            </p>
          </div>
          {/* 美观统一的图片展示 */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="flex flex-col gap-3 sm:gap-4 mb-8">
            ...
            <p className="text-base sm:text-lg text-slate-700 leading-relaxed max-w-3xl">
              Key specifications and materials for four shaft shredder blades.
            </p>
          </div>
              ...
              <div className="space-y-4">
                <div>
                  <ul className="space-y-2">
                    {['Plastic films & pipes', 'MSW & TDF preparation', 'Mixed waste processing'].map((app, index) => (
